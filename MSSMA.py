...
cadet_location = "C:\\Users\\kosh_000\\Amgen\\CADET\\CADET3_Release\\bin\\cadet-cli.exe"
...
def createLoad(inlet):
    ...
    set_double(sec, 'CONST_COEFF', [92.0, 0.10631294584377825])
    set_double(sec, 'LIN_COEFF', [0.0, 0.0])
    set_double(sec, 'QUAD_COEFF', [0.0, 0.0])
    set_double(sec, 'CUBE_COEFF', [0.0, 0.0])

def createWash(inlet):
    sec = inlet.create_group('sec_001')

    set_double(sec, 'CONST_COEFF', [69.97439960989882, 0.0])
    set_double(sec, 'LIN_COEFF', [0.0, 0.0])
    set_double(sec, 'QUAD_COEFF', [0.0, 0.0])
    set_double(sec, 'CUBE_COEFF', [0.0, 0.0])
...
def createElute(inlet):
    ...
    set_double(sec, 'CONST_COEFF', [69.97439960989882, 0.0])
    set_double(sec, 'LIN_COEFF', [0.053, 0.0])
    set_double(sec, 'QUAD_COEFF', [0.0, 0.0])
    set_double(sec, 'CUBE_COEFF', [0.0, 0.0])
...
def createColumn(model):
    ...
    set_double(column, 'FILM_DIFFUSION', [2.14E-4, 2.1e-5])
    set_double(column, 'INIT_C', [69.9743996098988, 0.0])
    set_double(column, 'INIT_Q', [223.547, 0.0, 0.0])
    set_int(column, 'NCOMP', 2)
    set_double(column, 'PAR_DIFFUSION', [4.08E-10, 9.0E-12])
    set_double(column, 'PAR_POROSITY', 0.39)
    set_double(column, 'PAR_RADIUS', 3.25E-5)
    set_double(column, 'PAR_SURFDIFFUSION', [0.0, 0.0, 0.0])
...
def createAdsorption(column):
    ...
    set_double(ads, 'MSSMA_KA', [0.0, 1.0652004307518004E31, 7.724553149425915E26])
    set_double(ads, 'MSSMA_KD', [0.0, 5.88452172578919E31, 1.955092026422206E36])
    set_double(ads, 'MSSMA_LAMBDA', 223.547)
    set_double(ads, 'MSSMA_NU', [0.0, 9.618977853171593, 24.75290977103934])
    set_double(ads, 'MSSMA_SIGMA', [0.0, 47.82861669713074, 65.93967947378826])
    set_double(ads, 'MSSMA_REFQ', 223.547)
    set_double(ads, 'MSSMA_REFC0', 520.0)
    set_double(ads, 'MSSMA_RATES', [0.0, 0.0, 9.39710359947847E39, 9.503195767335168, 0.0])
